...
AITrainer.prototype.train = function(){
    ...
    if(!ballsMoving){
        ...
        if(AI.iteration !== 0){
            ...
            if(LOG){
                console.log('--------Generation '+new Number(AI.iteration+1)+'--------------------');
...
AITrainer.prototype.playTurn = function(){
    ...
    console.log('~~~~~~~~~~~~~**~~~~~~~~~~~~~');
    console.log('Optimal rotation: ' + AI.opponents[AI.bestOpponentIndex]['rotation']*(-57.2958));
    console.log('Optimal power: ' + AI.opponents[AI.bestOpponentIndex]['power']);
    console.log('Optimal evaluation: ' + AI.opponents[AI.bestOpponentIndex]['evaluation']);
    console.log('~~~~~~~~~~~~~**~~~~~~~~~~~~~');
